...
#rom int8 0xF00000={
   ...
   // Sensor1
    ...
    hilo(100), // Oberer Grenzwert (UEG x10)
   ...
   // Sensor2
    ...
    hilo(50),  // Sensor1 Schwelle Alarmpunkt 2 LOWByte
    ...
    hilo(70),  // Sensor1 Schwelle Alarmpunkt 3 LOWByte
    ...
    hilo(50),  // Sensor2 Schwelle Alarmpunkt 2 LOWByte
    ...
    hilo(70),  // Sensor2 Schwelle Alarmpunkt 3 LOWByte
