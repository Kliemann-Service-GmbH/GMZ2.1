...
#rom int8 0xF00000={
    ...
    // Sensor1
    3,          // Typ Sensor1 (siehe Datei LCD.h)
    2,          // Einheit Sensor1 (0=UEG, 1=VOL, 2=ppm)
    hilo(30000), // Oberer Grenzwert (UEG x10)
    ...
    // Sensor2
    3,          // Typ Sensor2 (siehe Datei LCD.h)
    ...
    // Alarm Einstellungen
    // Sensor1
    hilo(10000),  // Sensor1 Schwelle Alarmpunkt 1 LOWByte
    ...
    hilo(15000),  // Sensor1 Schwelle Alarmpunkt 2 LOWByte
    ...
    hilo(20000),  // Sensor1 Schwelle Alarmpunkt 3 LOWByte
    ...
    // Alarm Einstellungen
    // Sensor2
    hilo(10000),  // Sensor2 Schwelle Alarmpunkt 1 LOWByte
    ...
    hilo(15000),  // Sensor2 Schwelle Alarmpunkt 2 LOWByte
    ...
    hilo(20000),  // Sensor2 Schwelle Alarmpunkt 3 LOWByte
