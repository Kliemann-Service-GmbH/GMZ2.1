...
#rom int8 0xF00000={
   ...
   // Sensor1
    5,          // Typ Sensor1 (siehe Datei LCD.h)
    2,          // Einheit Sensor1 (0=UEG, 1=VOL, 2=ppm)
    hilo(20), // Oberer Grenzwert (UEG x10)
    ...
    // Sensor2
    5,          // Typ Sensor2 (siehe Datei LCD.h)
    ...
    // Alarm Einstellungen
    // Sensor1
    hilo(7),  // Sensor1 Schwelle Alarmpunkt 1 LOWByte
    hilo(2),   // Sensor1 Hysterese Alarmpunkt 1 LOWByte
    ...
    hilo(10),  // Sensor1 Schwelle Alarmpunkt 2 LOWByte
    hilo(2),   // Sensor1 Hysterese Alarmpunkt 2 LOWByte
    ...
    hilo(15),  // Sensor1 Schwelle Alarmpunkt 3 LOWByte
    hilo(2),   // Sensor1 Hysterese Alarmpunkt 3 LOWByte
    ...
    // Alarm Einstellungen
    // Sensor2
    hilo(7),  // Sensor2 Schwelle Alarmpunkt 1 LOWByte
    hilo(2),   // Sensor2 Hysterese Alarmpunkt 1 LOWByte
    ...
    hilo(10),  // Sensor2 Schwelle Alarmpunkt 2 LOWByte
    hilo(2),   // Sensor2 Hysterese Alarmpunkt 2 LOWByte
    ...
    hilo(15),  // Sensor2 Schwelle Alarmpunkt 3 LOWByte
    hilo(2),   // Sensor2 Hysterese Alarmpunkt 3 LOWByte
