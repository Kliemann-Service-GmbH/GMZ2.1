...
#rom int8 0xF00000={
   ...
   // Sensor1
    26,          // Typ Sensor1 (siehe Datei LCD.h)
    2,          // Einheit Sensor1 (0=UEG, 1=VOL, 2=ppm)
    hilo(5000), // Oberer Grenzwert (UEG x10)
    ...
    // Sensor2
    26,          // Typ Sensor2 (siehe Datei LCD.h)
    ...
    // Alarm Einstellungen
    // Sensor1
    hilo(2000),  // Sensor1 Schwelle Alarmpunkt 1 LOWByte
    ...
    hilo(3000),  // Sensor1 Schwelle Alarmpunkt 2 LOWByte
    ...
    hilo(4000),  // Sensor1 Schwelle Alarmpunkt 3 LOWByte
    ...
    // Alarm Einstellungen
    // Sensor2
    hilo(2000),  // Sensor2 Schwelle Alarmpunkt 1 LOWByte
    ...
    hilo(3000),  // Sensor2 Schwelle Alarmpunkt 2 LOWByte
    ...
    hilo(4000),  // Sensor2 Schwelle Alarmpunkt 3 LOWByte
