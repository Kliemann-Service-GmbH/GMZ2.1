...
void STyp(Kanal,b)
{
    ...
    else if(b==16){STypout[0]='C';STypout[1]='3';STypout[2]='H';STypout[3]='8';}                    // Propan R290
    ...
    else if(b==19){STypout[0]='R';STypout[1]='4';STypout[2]='1';STypout[3]='0';}                    // 
    else if(b==20){STypout[0]='R';STypout[1]='a';STypout[2]='u';STypout[3]='c';STypout[4]='h';}     // 
    ...
    else if(b==25){STypout[0]='C';STypout[1]='4';STypout[2]='H';STypout[3]='1';STypout[4]='0';}     // Butan R600
